<?php
   ...
   $searchQuery = " ";
   if($searchValue != ''){
      $searchQuery = " AND (producto LIKE :producto OR quantidade LIKE :quantidade OR valortotal LIKE :valortotal OR valortotal LIKE :valortotal OR mes LIKE :mes OR ano LIKE :ano) ";
      $searchArray = array( 'producto'=>"%$searchValue%",'quantidade'=>"%$searchValue%", 'valortotal'=>"%$searchValue", 'mes'=>"%$searchValue%", 'ano'=>"%$searchValue%");
   }
